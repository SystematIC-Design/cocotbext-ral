...
def main():
    ...
    parser.add_argument('-u',
                        action='store_true',
                        help='Output as UVM Python Register class')
    ...
    arg_to_format = [('j', ('json', None)), ('c', ('compact', None)),
                     ('d', ('html', None)), ('doc', ('docs', None)),
                     ('r', ('rtl', 'src_rtl')), ('s', ('dv', 'dv')),
                     ('f', ('fpv', 'fpv/vip')), ('cdefines', ('cdh', None)),
                     ('ctdefines', ('cth', None)), ('u', ('py', 'tb_coco/ral'))]
    format = None
    dirspec = None
